...
public class DeveloperTrainingSessionPublishService extends AbstractService<Developer, TrainingSession> {
	 ...
	 * 
	 * final boolean authorise = trainingSession != null && trainingSession.getDraftMode() == true && trainingSession.getTrainingModule().getDeveloper().getUserAccount().getId() == userAccountId;
	 * 
	 ...
	 * assert object != null;
	 * 
	 * Dataset dataset = super.unbind(object, "code", "iniDate", "finalDate", "location", "instructor", "contactEmail", "link", "draftMode");
	 * 
