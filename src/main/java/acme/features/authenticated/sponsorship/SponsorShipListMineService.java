...
@Service
public class SponsorShipListMineService extends AbstractService<Sponsor, SponsorShip> {
	...
	public void load() {
		...
		objects = this.repo.findManySponsorShipByInvoiceId(principal.getActiveRoleId());
